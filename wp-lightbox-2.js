...
(function($){
    //for wipe event prevent scrolling wrong direction
    $('head').append('<style type="text/css">.stop-scrolling {  height: 100%;  overflow: hidden;}</style>'); 
...
/*2.28.4 -  Compatible with wordpress 3.6.*/
        ...
        function showImage() {
            ...
            opts.inprogress = false;
            var swipeIt = new SwipeIt("#imageContainer", {minDistance: 80});
            swipeIt.on("swipeRight", function(e) {
                        jQuery('#nextLink,#nextLinkText').click();
            })
            .on("swipeLeft", function(e) {
                        jQuery('#prevLink,#prevLinkText').click();
            });
        };
